...
/**
 * BTrail19SerialCommConfig Handles the serial communication for the driver.
 *
 * @author mithun on 27 May 2025
 */
@NiagaraType
public class BTrail19SerialCommConfig
...
/* Generated Tue May 27 15:03:53 EDT 2025 by Slot-o-Matic (c) Tridium, Inc. 2012-2025 */
  ...
  public static final Type TYPE = Sys.loadType(BTrail19SerialCommConfig.class);
...
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
   ...
   * Empty constructor
   */
  public BTrail19SerialCommConfig()
  {
  }
...
//  public int getMaxOutstandingTransactions() { return 1; }
  ...
  protected NLinkMessageFactory makeLinkMessageFactory()
  {
    ...
    return new NLinkMessageFactory(1024)
    {
      ...
      {
        return new Trail19SerialLinkMessage(1024);
      }
    };
  }
